...
// --- Agent 工具 API ---
export type AssistantToolMetadata = components['schemas']['AssistantToolMetadata']

export async function listAssistantTools(): Promise<AssistantToolMetadata[]> {
  return await request.get<AssistantToolMetadata[]>('/ai/assistant/tools', undefined, '/api', {
    showLoading: false
  })
}
